...
| [PerryLink/dsh-fast](https://github.com/PerryLink/dsh-fast) | Read-only performance diagnostics: session load timing, spill hits, compaction stats, context volume and LLM cache-hit rate via /fast (`dsh plugin --profile web add dsh-fast`) | 6 |

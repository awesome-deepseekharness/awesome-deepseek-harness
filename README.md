...
| [PerryLink/dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) | LSP diagnostics, formatting, completion, code actions, symbols and rename driven by real language servers (`dsh plugin --profile web add dsh-lsp-actions`) | 19 |

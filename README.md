...
| [PerryLink/dsh-observe](https://github.com/PerryLink/dsh-observe) | OpenTelemetry and Langfuse export of turn/step/tool spans and token/cost metrics, sanitized and off by default (`dsh plugin --profile web add dsh-observe`) | 6 |

...
| [PerryLink/dsh-score](https://github.com/PerryLink/dsh-score) | Multi-dimensional plugin quality scoring (install success, maintenance, docs, security scan, protocol compliance) with evidence-linked reports (`dsh plugin --profile web add dsh-score`) | 4 |

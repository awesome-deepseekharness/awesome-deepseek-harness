...
| [PerryLink/dsh-talk](https://github.com/PerryLink/dsh-talk) | Voice-first session loop: a composer microphone with browser/local speech-to-text, a speak tool for text-to-speech replies, and speak-to-interrupt (`dsh plugin --profile web add dsh-talk`) | 10 |
### 🖥️ TUI & Desktop

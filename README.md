...
| [PerryLink/dsh-plugin-upgrade-015](https://github.com/PerryLink/dsh-plugin-upgrade-015) | Merged version-locked plugin upgrade corridor (0.1.3-alpha.1 → 0.1.5-rc.1): an evidence-bound version card plus a zero-dependency 20-seam scanner (`dsh plugin --profile web add dsh-plugin-upgrade-015`) | 0 |

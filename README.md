...
| [PerryLink/dsh-mask](https://github.com/PerryLink/dsh-mask) | PII masking at the model boundary with a host-side restore table; plaintext never enters the session log (`dsh plugin --profile web add dsh-mask`) | 6 |

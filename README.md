...
| [PerryLink/dsh-skill-pack-security](https://github.com/PerryLink/dsh-skill-pack-security) | Security-audit skill pack (secret scan, dependency audit, threat modeling, incident response) plus the plugin_vet supply-chain gate (`dsh plugin --profile web add dsh-skill-pack-security`) | 11 |

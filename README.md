...
| [PerryLink/dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | Engineering-discipline guard for dsh: grill the requirements, gate the implementation with tests, and adversarially review the delivery before shipping (`dsh plugin --profile web add dsh-doublecheck`) | 27 |

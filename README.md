...
| [PerryLink/dsh-output-styles](https://github.com/PerryLink/dsh-output-styles) | Runtime-switchable model output styles with Claude Code outputStyles parity (`dsh plugin --profile web add dsh-output-styles`) | 5 |
### 🖥️ TUI & Desktop

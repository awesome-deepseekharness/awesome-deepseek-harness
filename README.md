...
| [PerryLink/dsh-defend](https://github.com/PerryLink/dsh-defend) | Prompt-injection, jailbreak and secret-leak detection with allow/ask/block tiers and sanitized audit events (`dsh plugin --profile web add dsh-defend`) | 12 |

...
| [PerryLink/dsh-translate](https://github.com/PerryLink/dsh-translate) | Vendor parameter translation across 11 model vendors plus deterministic JSON repair that never fabricates data (`dsh plugin --profile web add dsh-translate`) | 5 |

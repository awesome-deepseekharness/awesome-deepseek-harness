...
| [PerryLink/dsh-data-quality](https://github.com/PerryLink/dsh-data-quality) | Deterministic data profiling, cleaning and verification with a frozen cross-plugin citation-checking contract (`dsh plugin --profile web add dsh-data-quality`) | 23 |

...
| [PerryLink/dsh-budget](https://github.com/PerryLink/dsh-budget) | Token and cost metering per model, session and day with budget caps, threshold alerts, carbon estimates and latency benchmarks (`dsh plugin --profile web add dsh-budget`) | 5 |

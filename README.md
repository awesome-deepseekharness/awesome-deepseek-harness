...
| [PerryLink/dsh-test-drive](https://github.com/PerryLink/dsh-test-drive) | Isolated install-and-smoke test drives for dsh plugins in throwaway profiles, emitting structured pass/fail matrices (`dsh plugin --profile web add dsh-test-drive`) | 6 |

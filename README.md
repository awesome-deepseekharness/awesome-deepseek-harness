...
| [PerryLink/dsh-plugin-kit](https://github.com/PerryLink/dsh-plugin-kit) | Shared zero-runtime-dependency toolkit for dsh plugin authors: a pluggable Provider seam, fail-closed approval gates, verify scripts and sanitize/pricing/judge modules (`npm i -D @perrylink/dsh-plugin-kit`) | 0 |

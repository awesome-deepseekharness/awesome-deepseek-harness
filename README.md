...
| [PerryLink/dsh-draw](https://github.com/PerryLink/dsh-draw) | Unified static-image generation router over configurable OpenAI-compatible engines with health-aware fallback (`dsh plugin --profile web add dsh-draw`) | 6 |

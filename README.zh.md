...
| [PerryLink/dsh-team-rooms](https://github.com/PerryLink/dsh-team-rooms) | 持久化跨会话多 Agent 团队房间：成员、消息总线、共享任务板与重启后仍保留的时间线（`dsh plugin --profile web add dsh-team-rooms` 安装） | 0 |

...
| [PerryLink/dsh-github](https://github.com/PerryLink/dsh-github) | GitHub PR/issue 集成 + 轮询 PR 审查机器人与 composite Action；所有写操作审批门控（`dsh plugin --profile web add dsh-github` 安装） | 9 |

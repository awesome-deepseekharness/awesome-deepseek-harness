...
| [PerryLink/dsh-background-agents](https://github.com/PerryLink/dsh-background-agents) | 官方子代理接缝上的持久后台子代理：Web 侧边栏看进度、随时留言与打断（`dsh plugin --profile web add dsh-background-agents` 安装） | 12 |

...
| [PerryLink/dsh-cert-mcp](https://github.com/PerryLink/dsh-cert-mcp) | 只读 MCP 服务器，暴露 dsh-plugin-certification 注册表：等级、快照日期与五维证据（`npx @perrylink/dsh-cert-mcp` 运行） | 0 |

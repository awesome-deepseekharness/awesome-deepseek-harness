...
| [PerryLink/dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) | 终端式输入历史：方向键回溯、Ctrl+R 反查、按工作区隔离（`dsh plugin --profile web add dsh-composer-history` 安装） | 15 |

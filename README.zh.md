...
| [PerryLink/dsh-output-styles](https://github.com/PerryLink/dsh-output-styles) | 运行时切换模型输出风格（对标 Claude Code outputStyles）（`dsh plugin --profile web add dsh-output-styles` 安装） | 5 |

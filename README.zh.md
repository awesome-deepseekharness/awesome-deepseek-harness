...
| [PerryLink/dsh-test-drive](https://github.com/PerryLink/dsh-test-drive) | 一次性 profile 中的隔离安装+冒烟实测，输出结构化通过/失败矩阵（`dsh plugin --profile web add dsh-test-drive` 安装） | 6 |

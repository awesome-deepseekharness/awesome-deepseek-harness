...
| [PerryLink/dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) | 把 Claude Code/Codex/OpenCode/Hermes 的会话、记忆与技能迁入 dsh，会话可续（`dsh plugin --profile web add dsh-claude-move` 安装） | 20 |

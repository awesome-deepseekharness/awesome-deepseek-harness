...
| [weibaohui/dsh-settings-ui](https://github.com/weibaohui/dsh-settings-ui) | 设置界面自定义：调整原生设置窗口大小（全屏/预置/自定义宽高）、背景透明度与背景（主题/颜色/图片），悬浮球即开即调，存本机浏览器。`dsh plugin add @weibaohui/dsh-settings-ui` 即装 | 1 |

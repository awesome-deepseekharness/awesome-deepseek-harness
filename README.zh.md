...
| [PerryLink/dsh-observe](https://github.com/PerryLink/dsh-observe) | turn/step/tool span 与 token/成本指标的 OTLP/Langfuse 导出：脱敏、默认关闭（`dsh plugin --profile web add dsh-observe` 安装） | 6 |

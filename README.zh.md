...
| [PerryLink/dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) | 由真实语言服务器驱动的 LSP 诊断、格式化、补全、代码动作、符号与重命名（`dsh plugin --profile web add dsh-lsp-actions` 安装） | 19 |

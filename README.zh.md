...
| [PerryLink/dsh-skill-pack-security](https://github.com/PerryLink/dsh-skill-pack-security) | 安全审计技能包（密钥扫描/依赖审计/威胁建模/应急响应）+ plugin_vet 供应链门禁（`dsh plugin --profile web add dsh-skill-pack-security` 安装） | 11 |

...
| [PerryLink/dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 行业/公司研究领域包：产业链建图、公开源政策动态跟踪、公司速览卡与可核查研究报告（数字可溯源）（`dsh plugin --profile web add dsh-industry-research` 安装） | 100 |

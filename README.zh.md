...
| [weibaohui/user-management](https://github.com/weibaohui/user-management) | 用户管理：给 dsh web 加登录门禁，未登录访问弹登录/注册页，首个注册者自动成为管理员；管理员可管理用户/角色，带登录与访问审计。`dsh plugin add @weibaohui/user-management` 即装 | 1 |

...
| [PerryLink/dsh-plugin-upgrade-015](https://github.com/PerryLink/dsh-plugin-upgrade-015) | 合并后的锁版本升级走廊（0.1.3-alpha.1 → 0.1.5-rc.1）：带证据的版本卡 + 零依赖 20 接缝扫描器（`dsh plugin --profile web add dsh-plugin-upgrade-015` 安装） | 0 |

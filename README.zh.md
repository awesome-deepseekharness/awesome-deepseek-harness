...
| [PerryLink/dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | dsh 工程纪律护栏：动工前拷问需求、以测试门控实现、交付前对抗式审查（`dsh plugin --profile web add dsh-doublecheck` 安装） | 27 |

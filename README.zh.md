...
| [PerryLink/dsh-checkpoint-rewind](https://github.com/PerryLink/dsh-checkpoint-rewind) | 变更型工具执行前的 git 优先工作区快照 + 一键 /rewind：恢复文件并把会话分叉回检查点（`dsh plugin --profile web add dsh-checkpoint-rewind` 安装） | 18 |
